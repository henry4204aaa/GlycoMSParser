...
def summarize_target_evidence(result: GlobalEvidenceResult) -> pd.DataFrame:
    rows: list[dict[str, Any]] = []
    for target_id, te in sorted(result.target_evidence.items()):
        rows.append(
            {
                "target_id": target_id,
                "pass1_score": te.pass1_score,
                "pass2_score": te.pass2_score,
                "total_raw_score": te.total_raw_score,
                "total_max_score": te.total_max_score,
                "normalized_score": te.normalized_score,
                "supported": te.supported,
                "contributing_rule_rows": ",".join(map(str, te.contributing_rule_rows)),
            }
        )
