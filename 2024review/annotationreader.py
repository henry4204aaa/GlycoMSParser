...
MS2listheaders = ["Structure", "MS2scan_no", "peak", "charge", "mass shift", "adduct", "diff profile (integer for groups if different from same annotation)","IUPACname(optional)", "Glycanannotation2", "note"]
...
def read_annotation_excel(excel_file, supportxls):
    ...
    if supportxls is False:
        ...
        annotation_excelcheck(excel_file)
        print("Read excel file")
        xls = pd.ExcelFile(excel_file)
        print("Below is testing block")
