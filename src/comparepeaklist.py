...
def comparepeaklistppm(inputlist = [], comparelistglob = [], ppm = 500, inputintensitylist = [], debug = False, autoall= False):
    comparelist=comparelistglob[:] #prevent same reference in for loop #fix in 20231012
    ...
    if (inputintensitylist == []):
        ...
        #print('use default comparelist', inputintensitylist)
    else:
        #print('inputintensitylist in another file is', inputintensitylist)
        pass
    #ppm = ppmcalculation()
    ...
    if autoall:
        print("maxn of inputlist while not using comparelist")
    '''
